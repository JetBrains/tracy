 ...
 * @param adapter The [LLMTracingAdapter] that implements provider-specific tracing
 *                (see: `OpenAILLMTracingAdapter`, `AnthropicLLMTracingAdapter`, and `GeminiLLMTracingAdapter`).
