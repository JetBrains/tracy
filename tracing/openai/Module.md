...
- **[Chat Completions API](https://platform.openai.com/docs/api-reference/chat)**: Messages, model, temperature, tokens,
...
Use `instrument(client)` to enable tracing on an `OpenAIClient` instance. All API calls will automatically capture
