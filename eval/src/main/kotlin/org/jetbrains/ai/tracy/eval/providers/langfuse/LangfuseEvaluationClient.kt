...
package org.jetbrains.ai.tracy.eval.providers.langfuse
...
import org.jetbrains.ai.tracy.eval.utils.MultiScoreEvalResult
import org.jetbrains.ai.tracy.eval.utils.SingleScoreEvalResult
...
class LangfuseEvaluationClient(
...
) : org.jetbrains.ai.tracy.eval.utils.LoggingClient {
    ...
    override suspend fun uploadResults(
        runId: String,
        testResults: List<org.jetbrains.ai.tracy.eval.utils.TestResult<*, *, *, *>>
    ) {
