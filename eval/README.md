...
The ai-dev-kit-eval module provides a lightweight, extensible set of APIs for evaluating AI features and models. It
helps you define test cases, run generators, compute scores, and optionally log results to external tracking systems.
...
5. `class YourEval : LangfuseEvaluationTest<InputOfYourFeature, YourGT, OutputOfYourFeature, MultiScoreEvalResult>`
   ...
   You can use [NoLoggingEvaluationTest](src/main/kotlin/ai/dev/kit/eval/utils/NoLoggingEvaluationTest.kt) instead
   of [LangfuseEvaluationTest](src/main/kotlin/ai/dev/kit/eval/langfuse/LangfuseEvaluationTest.kt)
