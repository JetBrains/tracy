...
class LangfuseTracePublisher : TracePublisher {
    override suspend fun publishTrace(trace: List<SpanData>) {
        ...
        langfuseRequest(
            ...
            url = "${KotlinLangfuseClient.LANGFUSE_API}api/public/ingestion",
            body = payload
        )
    }
    ...
    private fun buildSpanCreateCall(span: SpanData): JsonObject {
        ...
        return buildJsonObject {
            ...
            put("timestamp", Instant.now().toString()) // TODO: fix
    ...
    companion object {
        ...
        suspend fun publishRootStartCall(span: ReadableSpan) {
