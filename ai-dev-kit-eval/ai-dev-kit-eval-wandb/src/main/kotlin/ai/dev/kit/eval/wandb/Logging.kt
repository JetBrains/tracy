...
import ai.dev.kit.eval.wandb.dataclasses.Call
import ai.dev.kit.eval.wandb.dataclasses.DeleteCallsRequest
...
internal suspend fun deleteAllTracesFromProject(projectId: String): JsonObject {
    ...
    val callIds = projectTraces.map { it.jsonObject["id"]!!.jsonPrimitive.content }.distinct()
