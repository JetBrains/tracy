package ai.dev.kit.eval.wandb.tracing

import ai.dev.kit.core.fluent.processor.TracingFlowProcessor
import ai.dev.kit.eval.wandb.KotlinWandbClient.TEST_PROJECT_NAME
import ai.dev.kit.eval.wandb.KotlinWandbClient.currentExperimentId
import ai.dev.kit.eval.wandb.deleteAllTracesFromProject
import ai.dev.kit.eval.wandb.fluent.WandBTracePublisher
...
interface WandbTracingTests {
    companion object {
        ...
        @JvmStatic
        fun setupProcessor() {
            TracingFlowProcessor.setupTracing(WandBTracePublisher)
        }
